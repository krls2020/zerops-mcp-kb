...
- **Semantic IDs**: Human-readable identifiers like `services/nodejs` or `recipe/laravel-jetstream`
...
### Types:
- `services/` - Zerops services (nodejs, postgresql, mariadb, etc.)
...
- **Service**: kbapi (go@1)
- **URL**: https://kbapi-167b-8080.prg1.zerops.app
...
https://github.com/krls2020/zerops-mcp-kb